...
//#define SPIM1_MISO_PIN  23   // SPI Master In Slave Out GPIO pin number.
//#define SPIM1_SS_PIN    9   // SPI Slave Select GPIO pin number.
//
//#define SPIM2_SCK_PIN   31  // SPI clock GPIO pin number.
//#define SPIM2_MOSI_PIN  25  // SPI Master Out Slave In GPIO pin number.
//#define SPIM2_MISO_PIN  11  // SPI Master In Slave Out GPIO pin number.
//#define SPIM2_SS_PIN    2  // SPI Slave Select GPIO pin number.
...
//#define ARDUINO_SCL_PIN             4    // SCL signal pin
//#define ARDUINO_SDA_PIN             5    // SDA signal pin
...
//#define NRF_CLOCK_LFCLKSRC      {.source       = NRF_CLOCK_LF_SRC_XTAL,  .rc_ctiv      = 0,.rc_temp_ctiv = 0, .accuracy     = NRF_CLOCK_LF_ACCURACY_20_PPM}
